...
public class GameMemoryRepository {
	...
	/**
	 * After Every 5 minutes(300000 milli seconds) interval this method tries to
	 * find the 60 minutes old game and remove them from map. So, if there is no
	 * activity on a game last 60 minutes, It will destroy.
	 */
