...
public class P360Variants implements Variants {
  private static final List<P360Field<Variant, ?>> VARIANT_FIELDS = Arrays.asList(
      ...
      new P360Field<>("VariantLang.TMEApplication(EN)", P360Field.Type.STRING, Variant::getShortDescription, Variant::setShortDescription),
      new P360Field<>("VariantLang.Keyword(EN)", P360Field.Type.MULTI_STRING, Variant::getKatashiki, Variant::setKatashiki));
  ...
  private static final List<P360Field<Options, ?>> OPTIONS_FIELDS = Arrays.asList(
      ...
      new P360Field<>("Variant.CurrentStatus", P360Field.Type.STRING, Options::getStatusCode, Options::setStatusCode),
      new P360Field<>("Variant.TMECancelationReason", P360Field.Type.LOOKUP, Options::getCancelledReason, Options::setCancelledReason),
      new P360Field<>("Variant.TMEGeneration", P360Field.Type.STRING, Options::getGeneration, Options::setGeneration),
      new P360Field<>("Variant.TMESubprojects", P360Field.Type.MULTI_STRING, Options::getSubProjectIds, Options::setSubProjectIds),
      new P360Field<>("VariantLang.TMESubprojects(EN)", P360Field.Type.MULTI_STRING, Options::getSubProjects, Options::setSubProjects),
      new P360Field<>("Variant.TMEBodyTypes", P360Field.Type.MULTI_STRING, Options::getBodyTypeIds, Options::setBodyTypeIds),
      new P360Field<>("VariantLang.TMEBodyTypes(EN)", P360Field.Type.MULTI_STRING, Options::getBodyTypes, Options::setBodyTypes),
      new P360Field<>("Variant.TMEEngines", P360Field.Type.MULTI_STRING, Options::getEngineIds, Options::setEngineIds),
      new P360Field<>("VariantLang.TMEEngines(EN)", P360Field.Type.MULTI_STRING, Options::getEngines, Options::setEngines),
      new P360Field<>("Variant.TMETransmissions", P360Field.Type.MULTI_STRING, Options::getTransmissionIds, Options::setTransmissionIds),
      new P360Field<>("VariantLang.TMETransmissions(EN)", P360Field.Type.MULTI_STRING, Options::getTransmissions, Options::setTransmissions),
      new P360Field<>("Variant.TMEFactoryGrades", P360Field.Type.MULTI_STRING, Options::getProductionGradeIds, Options::setProductionGradeIds),
      new P360Field<>("VariantLang.TMEFactoryGrades(EN)", P360Field.Type.MULTI_STRING, Options::getProductionGrades, Options::setProductionGrades),
      new P360Field<>("Variant.TMEProductionLocations", P360Field.Type.MULTI_STRING, Options::getProductionLocationIds, Options::setProductionLocationIds),
      new P360Field<>("VariantLang.TMEProductionLocations(EN)", P360Field.Type.MULTI_STRING, Options::getProductionLocations, Options::setProductionLocations),
      new P360Field<>("Variant.TMESteering", P360Field.Type.STRING, Options::getSteeringId, Options::setSteeringId),
      new P360Field<>("VariantLang.TMESteering(EN)", P360Field.Type.STRING, Options::getSteering, Options::setSteering),
      new P360Field<>("Variant.TMEEquipmentSpecs", P360Field.Type.MULTI_STRING, Options::getFactoryEquipmentIds, Options::setFactoryEquipmentIds),
      new P360Field<>("VariantLang.TMEEquipmentSpecs(EN)", P360Field.Type.MULTI_STRING, Options::getFactoryEquipments, Options::setFactoryEquipments),
      new P360Field<>("Variant.TMEInteriorColours", P360Field.Type.MULTI_STRING, Options::getInteriorColourIds, Options::setInteriorColourIds),
      new P360Field<>("VariantLang.TMEInteriorColours(EN)", P360Field.Type.MULTI_STRING, Options::getInteriorColours, Options::setInteriorColours),
      new P360Field<>("Variant.TMEExteriorColours", P360Field.Type.MULTI_STRING, Options::getExteriorColourIds, Options::setExteriorColourIds),
      new P360Field<>("VariantLang.TMEExteriorColours(EN)", P360Field.Type.MULTI_STRING, Options::getExteriorColours, Options::setExteriorColours),
      new P360Field<>("Variant.TMETrimColours", P360Field.Type.MULTI_STRING, Options::getTrimColourIds, Options::setTrimColourIds),
      new P360Field<>("VariantLang.TMETrimColours(EN)", P360Field.Type.MULTI_STRING, Options::getTrimColours, Options::setTrimColours),
      new P360Field<>("Variant.TMECountries", P360Field.Type.MULTI_ENUM, Options::getCountries, Options::setCountries));
...
//      new P360Field<>("VariantLang.TMELocalModelCode(EN)", P360Field.Type.MULTI_STRING, Options::getLocalModelCode, Options::setLocalModelCode));
  ...
  private static final String READ_FIELDS = Stream.concat(
      VARIANT_FIELDS.stream(),
      OPTIONS_FIELDS.stream())
      .map(P360Field::name)
      .collect(Collectors.joining(","));

  private static final List<UpdateItemRequest.Column> WRITE_COLUMNS = Stream.concat(
      VARIANT_FIELDS.stream(), OPTIONS_FIELDS.stream())
      .filter(f -> !f.readOnly())
      .map(P360Field::name)
      .map(UpdateItemRequest.Column::new)
  ...
  public List<Variant> getForProduct(String productId) {
    ...
    GetResponse res = rest.getForObject(
        ...
        + "/rest/V2.0/list/Variant/byProducts"
    ...
    List<Variant> result = res.getRows().stream()
        .map(this::resolve)
        .collect(Collectors.toList());
  ...
  private void validateSaveResponse(Variant variant, UpdateItemResponse res) throws CouldNotSaveException, SavedWithErrorsException {
    ...
    UpdateItemRequest request = new UpdateItemRequest()
        ...
        .setRows(
            Collections.singletonList(
                ...
                .setObject(new UpdateItemRequest.Row.RowObject(id))
                .setValues(values)));
  ...
  private void bind(String variantId, String productNumber) throws CouldNotSaveException {
    UpdateItemRequest request = new UpdateItemRequest()
        .setColumns(
            Collections.singletonList(
                new UpdateItemRequest.Column(String.format("SuperordinateProductReference.ReferencedSupplierAid(\"%s\")", productNumber))))
        .setRows(
            Collections.singletonList(
                new UpdateItemRequest.Row()
                .setObject(new UpdateItemRequest.Row.RowObject(variantId))
                .setValues(
                    Collections.singletonList(""))));
  ...
  private String getLabel() {
    GetResponse response = rest.getForObject(pimProperties.getServer() +
            "/rest/V2.0/list/LookupValue/" +
            "byIdentifiers/?lookup=identifierGenerator&identifiers=" + ID_GENERATION_FIELD  +
            "&fields=LookupValue.Order",
            GetResponse.class);
  ...
  private void updateLabel(int newNo) {
    UpdateItemRequest request = new UpdateItemRequest()
            .setColumns(
                    Collections.singletonList(
                            new UpdateItemRequest.Column("LookupValue.Order")))
            .setRows(
                    Collections.singletonList(
                            new UpdateItemRequest.Row()
                                    .setObject(new UpdateItemRequest.Row.RowObject("'" + ID_GENERATION_FIELD +"'@'identifierGenerator'" ))
                                    .setValues(
                                            Collections.singletonList(newNo))));

    UpdateItemResponse response = rest.postForObject(pimProperties.getServer() +
              "/rest/V2.0/list/LookupValue",
               request,
               UpdateItemResponse.class);
