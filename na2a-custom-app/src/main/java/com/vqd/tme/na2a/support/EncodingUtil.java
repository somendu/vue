...
public class EncodingUtil {
  /**
   * Decodes the passed UTF-8 String using an algorithm that's compatible with JavaScript's <code>
   * decodeURIComponent</code> function. Returns <code>null</code> if the String is <code>null
   * </code>.
   *
