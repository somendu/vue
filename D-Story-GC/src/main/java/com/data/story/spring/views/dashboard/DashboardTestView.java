package com.data.story.spring.views.dashboard;
...
//@Route(value = "dashboardTest", layout = MainView.class)
//@RouteAlias(value = "", layout = MainView.class)
@PageTitle("DashboardTest")
@CssImport(value = "styles/views/dashboard/dashboard-view.css", include = "lumo-badge")
@JsModule("@vaadin/vaadin-lumo-styles/badge.js")
public class DashboardTestView extends Div implements AfterNavigationObserver {
	...
	public DashboardTestView() {
		...
		WrapperCard gridWrapper = new WrapperCard("wrapper", new Component[] { new H3("Service health"), grid },
				"card");
